                ...
                <a href="#"
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
                            Afzal Haqqi Rayyan Nugraha</h5>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Mahasiswa kupu-kupu dari TRM, masih
                            pemula perkara ngoding dan suka cari yang mudah-mudah saja.</p>
                    </div>
                </a>
            </div>
